 ...
 */
#define	PLAT_ARM_CLUSTER_COUNT		MA35H0_CLUSTER_COUNT
...
#define	PLAT_ARM_TZC_NS_DEV_ACCESS	TZC_REGION_ACCESS_RDWR(MA35H0_NSAID_TZNS)

/*
 * GIC related constants to	cater for both GICv2 and GICv3 instances of	an
 * MA35D0. They	could be overriden at runtime in case the MA35D0 implements	the	legacy
 * VE memory map.
 */
...
#define	PLAT_ARM_G1S_IRQ_PROPS(grp)	\
	...
	INTR_PROP_DESC(MA35H0_IRQ_TZ_WDOG, GIC_HIGHEST_SEC_PRIORITY, (grp),	\
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(MA35H0_IRQ_SEC_SYS_TIMER, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL)
...
#define	PLAT_ARM_SP_IMAGE_STACK_BASE	(PLAT_SP_IMAGE_NS_BUF_BASE + PLAT_SP_IMAGE_NS_BUF_SIZE)

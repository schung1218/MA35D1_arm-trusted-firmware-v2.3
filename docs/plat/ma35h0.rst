...
-  Build TF-A
   ...
   normal built command:
       ...
       CROSS_COMPILE=aarch64-linux-gnu- make PLAT=ma35h0  (bl2, bl31, DTB)

	CROSS_COMPILE=aarch64-linux-gnu- make PLAT=ma35h0 \
   ...
   tools:
	./tools/cert_create/cert_create -n --rot-key "build/ma35h0/release/rot_key.pem" \
		--tfw-nvctr 0 \
		--ntfw-nvctr 0 \
		--trusted-key-cert fiptool_images/trusted-key-cert.key-crt \
		--soc-fw=build/ma35h0/release/bl31.bin \
       ...
       CROSS_COMPILE=aarch64-linux-gnu- make PLAT=ma35h0 fiptool
